...
MODULE SahaInternalEnergyEOSDeclarationsN
  IMPLICIT NONE
  SAVE
  PUBLIC
  ...
  REAL, PARAMETER :: tol_m3  = 1.0e-3
  REAL, PARAMETER :: tol_p3  = 1.0e3
  INTEGER :: tol_count = 0
  REAL :: tolA = tol_m3
  REAL (kind=ikind) :: f_factor 

  ! CGS 
  INTEGER, PARAMETER :: lower_U  = 100
!  INTEGER, PARAMETER :: lower_U  = 3000
  ...
  REAL (KIND=ikind) :: A_n, B_n, C_n, D_n
  REAL (KIND=ikind) :: dB_n, dC_n, dD_n
...
END MODULE SahaInternalEnergyEOSDeclarationsN
