...
PROGRAM saha_hydrogen_pressure_eos_bisection
  ...
  OPEN(10, FILE='outfiles/saha_hydrogen_pressure_eos_bisection.dat')
...
!      N_e1 = n(1) * v_e(1) 
   ...
   !     PRINT *, 'THERE ', (N_e_last - N_e1)/N_e_last, ' ', (N_e - N_e1)/N_e
    ...
    WRITE(10,*) T_N_e,' ', y_h(1), ' ', P, ' ', Pressure(y_h(1), T_N_e)
          
  END DO

END PROGRAM saha_hydrogen_pressure_eos_bisection
